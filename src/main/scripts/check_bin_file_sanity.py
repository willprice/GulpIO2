...
if __name__ == "__main__":
    path_to_chunk = "/media/4TBSATA/20bn-objects_gulpio/validation_20170628/"
    path_bin = os.path.join(path_to_chunk, "data000.bin")
    path_meta = os.path.join(path_to_chunk, "meta000.bin")
    ...
    gulp_file.open()
    pprint(gulp_file.meta_dict['533571'])
